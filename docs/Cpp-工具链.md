# PLauncher 第三方库清单说明文档

**Generated by DeepSeek R1**

详见：https://gitee.com/Pfolg/plauncher/blob/master/CMakeLists.txt

## 项目概述
PLauncher 是一款基于 Live2D 角色驱动的启动器应用，使用 C++ 和 Qt 框架开发，整合了多种第三方库以实现图形渲染、动画驱动和跨平台功能。
...
- **集成方式**:
```cmake
target_link_libraries(PLauncher libglew32d.dll)
```
