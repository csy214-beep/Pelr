...
* merge branch dev to master by @csy214-beep in <https://github.com/csy214-beep/Pelr/pull/1>
* chore: add action & pr template by @csy214-beep in <https://github.com/csy214-beep/Pelr/pull/2>
* chore(deps): bump certifi from 2026.2.25 to 2026.4.22 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/3>
* chore(deps): bump packaging from 26.0 to 26.2 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/4>
* chore(deps): bump pyside6-addons from 6.10.1 to 6.11.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/5>
* chore(deps): bump gevent from 25.9.1 to 26.4.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/12>
* chore(deps): bump pyinstaller-hooks-contrib from 2026.0 to 2026.4 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/11>
* chore(deps): bump click from 8.3.1 to 8.3.3 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/6>
* chore(deps): bump aiohttp from 3.13.4 to 3.13.5 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/8>
* chore(deps): bump shiboken6 from 6.10.1 to 6.11.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/9>
* chore(deps): bump pyinstaller from 6.18.0 to 6.20.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/10>
* chore(deps): bump pyside6 from 6.10.1 to 6.11.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/7>
* chore(deps): bump zope-interface from 8.2 to 8.4 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/16>
* chore(deps): bump werkzeug from 3.1.7 to 3.1.8 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/15>
* chore(deps): bump idna from 3.11 to 3.13 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/14>
* chore(deps): bump greenlet from 3.3.2 to 3.4.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/13>
* chore(deps): bump greenlet from 3.4.0 to 3.5.0 by @dependabot[bot] in <https://github.com/csy214-beep/Pelr/pull/17>
* release：20260405.12.18 by @csy214-beep in <https://github.com/csy214-beep/Pelr/pull/18>

## New Contributors

* @csy214-beep made their first contribution in <https://github.com/csy214-beep/Pelr/pull/1>
* @dependabot[bot] made their first contribution in <https://github.com/csy214-beep/Pelr/pull/3>
